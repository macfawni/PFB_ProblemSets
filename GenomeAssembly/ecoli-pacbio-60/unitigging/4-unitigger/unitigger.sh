...
if [ -e ecoli-60.ctgStore/seqDB.v001.tig ]; then
  exists=true
else
  exists=false
fi
...
if [ -e ./ecoli-60.ctgStore ] ; then
  mv ./ecoli-60.ctgStore ../ecoli-60.ctgStore
fi
...
#
if [ -e ../ecoli-60.ctgStore -a \
   ! -e ../ecoli-60.ctgStore/seqDB.v001.sizes.txt ] ; then
  $bin/tgStoreDump \
    -S ../../ecoli-60.seqStore \
    -T ../ecoli-60.ctgStore 1 \
    -sizes -s 4800000 \
   > ../ecoli-60.ctgStore/seqDB.v001.sizes.txt
fi

if [ -e ../ecoli-60.ctgStore ] ; then
  cd ../ecoli-60.ctgStore
  cd -
fi
