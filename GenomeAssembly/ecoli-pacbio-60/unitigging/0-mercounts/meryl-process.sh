...
if [ $exists1 = true -a $exists2 = true -a $exists3 = true ] ; then
  echo "Output files 'ecoli-60.ms22.histogram', 'ecoli-60.ms22.dump' and 'ecoli-60.ms22.ignore.gz' exist in 'unitigging/0-mercounts'."
  exit 0
fi
...
if [ ! -e ./ecoli-60.ms22/merylIndex ] ; then
  /Users/pfb01/problemsets/GenomeAssembly/canu-2.2/bin/meryl threads=4 memory=2 \
    greater-than 1 \
...
if [ ! -e ./ecoli-60.ms22.histogram ] ; then
  /Users/pfb01/problemsets/GenomeAssembly/canu-2.2/bin/meryl threads=1 memory=1 \
...
if [ ! -e ./ecoli-60.ms22.ignore.gz ] ; then
  ...
  totKmers=`/Users/pfb01/problemsets/GenomeAssembly/canu-2.2/bin/meryl statistics ./ecoli-60.ms22 | grep present | awk '{ print $2 }'`
